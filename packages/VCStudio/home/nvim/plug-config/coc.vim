...
"DemonH
"Use la pestaña para activar la finalización con caracteres por delante y navegue.  
...
" no select by `"suggest.noselect": true`  en su archivo de configuración "otro complemento antes de poner esto en su configuración.
